...
[{
	"resource": "/Users/anthonysegovia/tiny-market/tests/tiny-market_test.ts",
	"owner": "typescript",
	"code": "2691",
	"severity": 8,
	"message": "An import path cannot end with a '.ts' extension. Consider importing 'https://deno.land/std@0.90.0/testing/asserts' instead.",
	"source": "ts",
	"startLineNumber": 3,
	"startColumn": 30,
	"endLineNumber": 3,
